---
name: template-bridge-bridge-internals
description: '[games/slot-game-template/assets/scripts/bridge] Bridge 層內部開發。修改 Loader、EventBridge、HostBridge 內部實現、 ServiceBridge 核心邏輯、類型同步機制時使用。'
---
