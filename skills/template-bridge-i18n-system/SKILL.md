---
name: template-bridge-i18n-system
description: '[games/slot-game-template/assets/scripts/bridge] 國際化系統。處理多語言翻譯、LanguageData、LocalizedLabel/Sprite/Spine、 語言切換、翻譯數據合併時使用。'
---
